...
{
    public class DbSchemeUserRelativeRepository : IDbSchemeUserRelativeRepository
    {
        private readonly SQLiteAsyncConnection connection;

        public DbSchemeUserRelativeRepository(SQLiteAsyncConnection connection)
        {
        ...
        /// <returns></returns>
        public Task<int> Add(DbSchemeUserRelative relative)
        {
            return connection.InsertAsync(relative);
        }
...
{paging.PagingSql()}";
    ...
    public interface IDbSchemeUserRelativeRepository
    {
        /// <summary>
        /// 添加
        /// </summary>
        /// <param name="relative"></param>
        /// <returns></returns>
        Task<int> Add(DbSchemeUserRelative relative);
