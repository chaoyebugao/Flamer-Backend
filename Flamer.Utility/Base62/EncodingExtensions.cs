...
namespace Flamer.Utility.Base62
{
    public static class EncodingExtensions
    {
        ...
        /// <summary>
        /// base62格式的Guid字符串转为Guid
        /// </summary>
        /// <param name="base62Guid"></param>
        /// <returns></returns>
        public static Guid ToGuid(this string base62Guid)
        {
            return new Guid(base62Guid.FromBase62());
        }
        #endregion
        ...
        /// <returns></returns>
        public static string ToBase62(this long data)
        {
            return BitConverter.GetBytes(data).ToBase62();
        }
        ...
        /// <param name="base62Guid"></param>
        /// <returns></returns>
        public static long ToLong(this string base62Long)
        {
            return BitConverter.ToInt64(base62Long.FromBase62());
        }
        #endregion
    }
}
